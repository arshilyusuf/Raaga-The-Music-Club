...
const DEFAULT_INNER_GRADIENT = 'linear-gradient(145deg,#252e08 0%,#252e08 100%)';
...
const ProfileCardComponent: React.FC<ProfileCardProps> = ({
  ...
  return (
    ...
    >
      ...
      {/* Instagram button — same as first code */}
      {instagram && (
        <a
          href={instagram}
          target="_blank"
      ...
      <div ref={shellRef} className="relative z-[1] group">
        ...
        >
          ...
          >
            {/* Shine layer — only renders when a real iconUrl is provided; without it the
                repeating-gradient stripes bleed through since the mask has nothing to clip to */}
            ...
            {/* Avatar — sits in lower half so it doesn't bleed behind the top name */}
            <div
