      ...
      <div className="flex items-center justify-between gap-2">
        ...
        <div className="flex items-center gap-2">
          ...
          <span className="text-gray-600">
            {expanded ? (
              <ChevronUpIcon size={14} className="transition duration-200 " onClick={() => setExpanded(!expanded)} />
            ) : (
              <ChevronDownIcon size={14} className="transition duration-200"  onClick={() => setExpanded(!expanded)} />
            )}
          </span>{" "}
        </div>
      </div>
